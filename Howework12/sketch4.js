...
function drawObstacles() {
    for (let i = 0; i < obstacles.length; i++) {
        ...
        if (i === 0) moveObstacleOne(o);
        else if (i === 1) moveObstacleTwo(o);
        else moveObstacleThree(o);
    }
}
